      ...
      <app>
               ...
               <div class="booking_login">
                  ...
                  <div >
                     <form name="confirm_form" class="ng-pristine ng-valid" id="form1" action="myreservation" method="post" >
                        ...
                        <button onClick="return checkForm(form1);" form="form1" class="login_btn confirm" > <span translate="CM-MY_BOOKING_CHECK">내 예약 확인</span> </button> <!----> <!----> <!----> <!----> 
                     </form>
                  </div>
                  <!----> <!----> 
               </div>
         ...
         <footer  aria-hidden="false">
            ...
            <div id="footer" class="footer"  >
               <ul class="lst_nav">
                  <!---->
                  <li class="lnk_item" > <a href="main" class="anchor _logout_link"> <span translate="CM-LOGIN">로그인</span> </a> </li>
                  <!----> <!----> 
                  <li class="lnk_item">
                     <!----> 
                  </li>
...
/* 	const reservationEmail = "${sessionScope.email}";
	window.addEventListener('load', function(){
		if(reservationEmail!=null) return window.location.href="myreservation";
	}); */
   document.getElementById("resrv_id").addEventListener('keydown', function(e){
   ...
   function checkForm(form){
	  let email = document.getElementById("resrv_id").value;
	  if(checkEmail(email)){
		 console.log(email);
		 return true;
	  }else {
